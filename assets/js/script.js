...
let quizQuestions = [
{
    ...
    G: "▫️ Run and grab my friend that still in the building.",
    R: "▫️ If I have a way to save my friend, then yes, but if I don't, sorry.",
    S: "▫️ Save myself, of course!",
    H: "▫️ I'll try, but I am not sure!",
  ...
  },
{
    ...
    G: "▫️ The thick, golden liquid, so shiny it hurts your eyes.",
    R: "▫️ The sparkling liquid that seems to have diamonds inside.",
    S: "▫️ The green liquid that emits vapors that cause strange visions.",
    H: "▫️ The pink drink that exudes a scent of cinnamon and ginger.",
    },
{
    question: "What do you think you would see in the Mirror of Erised?",
    G: "▫️ I would see myself saving the world from whatever it was",
    R: "▫️ I would find myself known for being the smartest wizard at the time",
    S: "▫️ I would find myself surrounded by money",
    H: "▫️ I would see myself with all the family that died",
   },
{
   ...
   },
{
    ...
    G: "▫️ I have only shared answers to friends in need",
    R: "▫️ Never",
    S: "▫️ I cheat any moment I get the opportunity",
    H: "▫️I tried, but never succeeded",
   },
{
    ...
    R: "▫️ Read books",
    S: "▫️ Make potions",
    H: "▫️ Create craft items",
    },
{
    question: "What do you want to achieve before you die?",
    G: "▫️ I want to travel the world",
    R: "▫️ I want to acquire as many skills as I can",
    S: "▫️ Be famous and have a lot of money",
    H: "▫️ Make as many friends as possible",
    },
{
    question: "How organized are you in your studies?",
    G: "▫️ Only that much is necessary",
    R: "▫️ I am the most organized person ever",
    S: "▫️ Who studies at all?",
    H: "▫️ I'm very organized. But I can improve",
    },

   { question: "What is your idea of a perfect vacation?",
    G:"▫️ Chilling out with friends and taking up new advetures",
    R:"▫️ Studyng and preparing or anny anual test/exam in advance",
    S:"▫️ Watch movies and relax",
    H:"▫️ Taking up an interactive or skill-based course", 
    },
];
